...
class PV_line_0x88_C {
  ...
  name_piece = new Array(PV_line_0x88_C.MAX_DEPTH).fill(-1);
  piece_color = new Array(PV_line_0x88_C.MAX_DEPTH).fill(-1);

  name_capture_piece = new Array(PV_line_0x88_C.MAX_DEPTH).fill(-1);
  ...
  add_move(move_i, move_list_0x88_O, depth) {
    ...
    this.name_piece[depth] = move_list_0x88_O.name_piece[move_i];
    this.piece_color[depth] = move_list_0x88_O.piece_color[move_i];

    this.name_capture_piece[depth] = move_list_0x88_O.name_capture_piece[move_i];
