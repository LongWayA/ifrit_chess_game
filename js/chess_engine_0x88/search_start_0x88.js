...
class Search_start_0x88_C {
  ...
  test_start_search(chess_board_0x88_O, move_generator_0x88_O, depth_max) {
    ...
    // min max
    //score = search_minmax_0x88_O.searching_minimax(chess_board_0x88_O, move_generator_0x88_O, depth, depth_max);
    //chess_board_0x88_O_move = search_minmax_0x88_O.chess_board_0x88_O_move;
    //this.pv_line_0x88_O = search_minmax_0x88_O.pv_line_0x88_O;

    score = this.search_ab_0x88_O.searching_alpha_beta(alpha, beta, chess_board_0x88_O, move_generator_0x88_O, depth, depth_max);
    this.chess_board_0x88_O_move = this.search_ab_0x88_O.chess_board_0x88_O_move;
    this.pv_line_0x88_O = search_ab_0x88_O.pv_line_0x88_O;

    //score = this.search_pvs_0x88_O.searching_alpha_beta(alpha, beta, chess_board_0x88_O, move_generator_0x88_O, depth, depth_max);
    //this.chess_board_0x88_O_move = this.search_pvs_0x88_O.chess_board_0x88_O_move;
    //this.pv_line_0x88_O = search_pvs_0x88_O.pv_line_0x88_O;
  ...
  start_search(chess_board_0x88_O, move_generator_0x88_O, depth_max) {
    ...
    score = this.searching_iterative_deepening(chess_board_0x88_O, move_generator_0x88_O, depth_max);
    //console.log("Search_0x88_C->start_search " + depth + " score " + score);
    console.log("Search_0x88_C->А ЧТО В ГЛАВНОМ ВАРИАНТЕ?");
    this.pv_line_0x88_O.test_print_pv_line(chess_board_0x88_O);
    return score;
  }

  // 
  searching_iterative_deepening(chess_board_0x88_O, move_generator_0x88_O, depth_max_2) {
      ...
      for (let move_i = 0; move_i < move_list_0x88_O.number_move; move_i++) {
        ...
        if (move_list_0x88_O.piece_color[move_i] == 1) {//
          ...
          if (score > best_score) {
            ...
            this.chess_board_0x88_O_move.save_chess_board_0x88(chess_board_0x88_O);
          }//if (score > best_score) {
  ...
  // 
  searching_PVS(alpha, beta, chess_board_0x88_O, move_generator_0x88_O, depth, depth_max) {
    let undo_0x88_O = new Undo_0x88_C();
    let score = 0;// текущая оценка позиции
    ...
    if (depth >= depth_max) {
      ...
      for (let move_i = 0; move_i < move_list_0x88_O.number_move; move_i++) {
        ...
        if (move_list_0x88_O.piece_color[move_i] == 1) {//
          ...
          //   move_list_0x88_O.score_move[move_i] = score;
          // } else {
          score = this.searching_PVS(alpha, (alpha + 1), chess_board_0x88_O, move_generator_0x88_O, (depth + 1), depth_max);
          move_list_0x88_O.score_move[move_i] = score;
          ...
          //   move_list_0x88_O.score_move[move_i] = score;
          // } else {
          score = this.searching_PVS((beta - 1), beta, chess_board_0x88_O, move_generator_0x88_O, (depth + 1), depth_max);
          move_list_0x88_O.score_move[move_i] = score;
