...
class Search_pvs_0x88_C {
  ...
  // 
  searching_PVS(alpha, beta, pv_line_0x88_O, chess_board_0x88_O, move_gen_1_captures_0x88_O, move_generator_0x88_O, depth, depth_max) {
    ...
    if (depth >= depth_max) {
      ...
      score = this.quiescence_search_0x88_O.quiescence_search(alpha, beta, pv_line_0x88_O, chess_board_0x88_O,
      ...
      for (let move_i = 0; move_i < move_list_0x88_O.number_move; move_i++) {
        ...
        if (move_list_0x88_O.piece_color[move_i] == 1) {//
          ...
          if (move_i == 0) {
            score = this.searching_PVS(alpha, beta, pv_line_0x88_O, chess_board_0x88_O, 
              move_gen_1_captures_0x88_O,  move_generator_0x88_O, (depth + 1), depth_max);
            move_list_0x88_O.score_move[move_i] = score;
          } else {
            score = this.searching_PVS(alpha, (alpha + 1), pv_line_0x88_O, chess_board_0x88_O, 
            move_gen_1_captures_0x88_O, move_generator_0x88_O, (depth + 1), depth_max);
            move_list_0x88_O.score_move[move_i] = score;
          ...
          if (move_i == 0) {
            ...
            score = this.searching_PVS((beta - 1), beta, pv_line_0x88_O, chess_board_0x88_O, 
            move_gen_1_captures_0x88_O,  move_generator_0x88_O, (depth + 1), depth_max);
            move_list_0x88_O.score_move[move_i] = score;
