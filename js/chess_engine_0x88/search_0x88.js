...
class Search_0x88_C {
  ...
  make_move_0x88_2_O = new Make_move_0x88_2_C();
  pv_line_0x88_2_O = new PV_line_0x88_2_C();
  ...
  start_search_2(chess_board_0x88_O, move_generator_0x88_O, depth_max) {
    ...
    let beta = 50000;
     ...
     score = this.searching_minimax_2(chess_board_0x88_O, move_generator_0x88_O, depth, depth_max);
     console.log("Search_0x88_C->start_search 2 " + depth + " score " + score);
     this.pv_line_0x88_2_O.test_print_pv_line(chess_board_0x88_O);
    // return score;
  }

  searching_minimax_2(chess_board_0x88_O, move_generator_0x88_O, depth, depth_max) {
    ...
    if (depth >= depth_max) {
      ...
      for (let move_i = 0; move_i < move_list_0x88_O.number_move; move_i++) {
        ...
        this.make_move_0x88_2_O.save_chess_board_0x88(chess_board_0x88_O, chess_board_0x88_O_save);
        is_moove_legal = this.make_move_0x88_2_O.do_moves(move_i, chess_board_0x88_O, move_list_0x88_O, undo_0x88_O, move_generator_0x88_O);
        //здесь должен быть контроль легальности хода
        if (is_moove_legal == 0) {
          this.make_move_0x88_2_O.restore_chess_board_0x88(chess_board_0x88_O, chess_board_0x88_O_save);
          continue;
        }
        score = this.searching_minimax_2(chess_board_0x88_O, move_generator_0x88_O, (depth + 1), depth_max);
        ...
        if (chess_board_0x88_O.side_to_move == 0) {// тут черные потому что ход за белых сделан, и мне нужно его записать, хотя
          ...
          if (score > found_score) {
            found_score = score;
            this.pv_line_0x88_2_O.add_move(move_i, move_list_0x88_O, depth);
            if (depth == 0) this.make_move_0x88_2_O.save_chess_board_0x88(chess_board_0x88_O, this.chess_board_0x88_O_move);
