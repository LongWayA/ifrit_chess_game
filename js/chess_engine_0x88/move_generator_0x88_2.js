...
class Move_generator_0x88_2_С {

    static NAME = "Move_generator_0x88_2_С";
  ...
  */
    ...
    */
            ...
            if (piece_color == side_to_move) {
                ...
                switch (piece_name) {
                    case Chess_board_0x88_C.KING:// KING
                        ...
                        this.generated_moves_king(piece_name, piece_color, from, chess_board_0x88_O, move_list_0x88_O);
                        this.generated_moves_castle_king(piece_color, from, chess_board_0x88_O, move_list_0x88_O);
                        break;

                    case Chess_board_0x88_C.QUEEN://QUEEN
                        this.generated_moves_queen(piece_name, piece_color, from, chess_board_0x88_O, move_list_0x88_O);
                        break;
                    case Chess_board_0x88_C.ROOK://ROOK
                        this.generated_moves_rook(piece_name, piece_color, from, chess_board_0x88_O, move_list_0x88_O);
                        break;
                    case Chess_board_0x88_C.BISHOP://BISHOP
                        this.generated_moves_bishop(piece_name, piece_color, from, chess_board_0x88_O, move_list_0x88_O);
                        break;
                    case Chess_board_0x88_C.KNIGHT://KNIGHT
                        this.generated_moves_knight(piece_name, piece_color, from, chess_board_0x88_O, move_list_0x88_O);
                        break;
                    case Chess_board_0x88_C.PAWN://PAWN
                        this.generated_moves_pawn(piece_name, piece_color, from, chess_board_0x88_O, move_list_0x88_O);
                        break;
    ...
    add_move(piece_name, piece_color, from, to, chess_board_0x88_O, move_list_0x88_O) {
    ...
    generated_moves_king(piece_name, piece_color, from, chess_board_0x88_O, move_list_0x88_O) {
        ...
        for (let j = 0; j < 8; j++) {
            ...
            if ((to & 136) == 0) {// если мы не вышли за пределы доски
                bre_ak = this.add_move(piece_name, piece_color, from, to, chess_board_0x88_O, move_list_0x88_O);
            }
        }
    }

    generated_moves_queen(piece_name, piece_color, from, chess_board_0x88_O, move_list_0x88_O) {
    ...
    generated_moves_rook(piece_name, piece_color, from, chess_board_0x88_O, move_list_0x88_O) {
    ...
    generated_moves_bishop(piece_name, piece_color, from, chess_board_0x88_O, move_list_0x88_O) {
    ...
    generated_moves_knight(piece_name, piece_color, from, chess_board_0x88_O, move_list_0x88_O) {
            ...
            if (piece_color == 1) {// король белый
                if (chess_board_0x88_O.castling_Q == 1) {// рокировка белых в длинную сторону   1/0
                    ...
                    if ((piece_to_1 == 0) && (piece_to_2 == 0) && (piece_to_3 == 0)) {//
                        ...
                        type_move = Move_list_0x88_2_С.MOVE_KING_QUEEN_CASTLE;
                        move_list_0x88_O.add_move(type_move, piece_color, score_move, from, to);
                    }
                }
                ...
                if (chess_board_0x88_O.castling_K == 1) {// рокировка белых в короткую сторону  1/0
                    ...
                    if ((piece_to_1 == 0) && (piece_to_2 == 0)) {//
                        ...
                        type_move = Move_list_0x88_2_С.MOVE_KING_CASTLE;
                        move_list_0x88_O.add_move(type_move, piece_color, score_move, from, to);
                    }
                }
            }
    ...
    generated_moves_pawn(piece_name, piece_color, from, chess_board_0x88_O, move_list_0x88_O) {
        ...
        if (piece_color == 1) {// белая пешка
            this.generated_moves_pawn_white(piece_name, piece_color, from, chess_board_0x88_O, move_list_0x88_O);
        } else if (piece_color == 0) {
            this.generated_moves_pawn_black(piece_name, piece_color, from, chess_board_0x88_O, move_list_0x88_O);
        }
    }


    //
    generated_moves_pawn_white(piece_name, piece_color, from, chess_board_0x88_O, move_list_0x88_O) {

        if (Math.floor(from / 16) == 6) {// белая пешка на стартовой позиции(2-ая линия). можно ходить на две клетки
            this.generated_moves_pawn_double(from, (from - 16), (from - 32), piece_name, piece_color,
        ...
        if (Math.floor(from / 16) == 1) {// белая пешка на на предпоследней позиции(7-ая линия). можно ходить с превращением
            this.generated_moves_pawn_promo(from, (from - 17), (from - 16), (from - 15), piece_name,
                piece_color, chess_board_0x88_O, move_list_0x88_O);
        } else {
            this.generated_moves_pawn_one(from, (from - 16), piece_name, piece_color, chess_board_0x88_O, move_list_0x88_O);
            this.generated_moves_pawn_captures(from, (from - 17), (from - 15), piece_name, piece_color, chess_board_0x88_O, move_list_0x88_O);
        }

    }

    //
    generated_moves_pawn_black(piece_name, piece_color, from, chess_board_0x88_O, move_list_0x88_O) {
        ...
        if (Math.floor(from / 16) == 6) {// 136 0x88
            this.generated_moves_pawn_promo(from, (from + 15), (from + 16), (from + 17), piece_name, piece_color,
                chess_board_0x88_O, move_list_0x88_O);
        } else {
            this.generated_moves_pawn_one(from, (from + 16), piece_name, piece_color, chess_board_0x88_O, move_list_0x88_O);
            this.generated_moves_pawn_captures(from, (from + 15), (from + 17), piece_name, piece_color, chess_board_0x88_O, move_list_0x88_O);
        }

    }

    // ход пешки на одну клетку
    generated_moves_pawn_one(from, to, piece_name, piece_color, chess_board_0x88_O, move_list_0x88_O) {
        let piece_to = -1;
        let type_move = -1;
        let score_move = -1;
    ...
    generated_moves_pawn_double(from, to_void, to, piece_name, piece_color, chess_board_0x88_O, move_list_0x88_O) {
        let piece_to = -1;
        let piece_to_void = -1;
        let type_move = -1;
        let score_move = -1;
        ...
        if ((piece_to == 0) && (piece_to_void == 0)) {// фигур там нет. можно ходить. это спокойный ход
            type_move = Move_list_0x88_2_С.MOVE_DOUBLE_PAWN;
            move_list_0x88_O.add_move(type_move, piece_color, score_move, from, to);
        }
    }

    generated_moves_pawn_captures(from, to_left, to_right, piece_name, piece_color, chess_board_0x88_O, move_list_0x88_O) {
        ...
        if ((to_left & 136) == 0) {// 136 0x88
            ...
            if ((piece_to != 0) && (piece_color != piece_color_to)) {// 
                ...
                type_move = move_list_0x88_O.return_type_simple_move(piece_name, capture_piece);
                ...
                type_move = Move_list_0x88_2_С.EP_CAPTURES;
                move_list_0x88_O.add_move(type_move, piece_color, score_move, from, to_left);
            }
        }
    ...
    generated_moves_pawn_promo(from, to_left, to_center, to_right, piece_name, piece_color, chess_board_0x88_O, move_list_0x88_O) {
        let piece_color_to = -1;
        let piece_to = -1;
        let capture_piece = -1;
        let type_move = -1;
        ...
        if (piece_to == 0) {// цвет не задан и значит фигуры там нет. можно ходить. это спокойный ход
            type_move = Move_list_0x88_2_С.MOVE_PAWN_PROMO_QUEEN;
            move_list_0x88_O.add_move(type_move, piece_color, score_move, from, to_center);
            type_move = Move_list_0x88_2_С.MOVE_PAWN_PROMO_ROOK;
            move_list_0x88_O.add_move(type_move, piece_color, score_move, from, to_center);
            type_move = Move_list_0x88_2_С.MOVE_PAWN_PROMO_BISHOP;
            move_list_0x88_O.add_move(type_move, piece_color, score_move, from, to_center);
            type_move = Move_list_0x88_2_С.MOVE_PAWN_PROMO_KNIGHT;
            move_list_0x88_O.add_move(type_move, piece_color, score_move, from, to_center);
        }
    ...
    check_detected(from, piece_color, chess_board_0x88_O) {
        ...
        let move_list_0x88_O = new Move_list_0x88_2_С();
        let check = -1;
        ...
        for (let i = 0; i < move_list_0x88_O.number_move; i++) {
            if (move_list_0x88_O.return_piece_name_captures_from_type_move(move_list_0x88_O.type_move[i]) == Chess_board_0x88_C.KING) {
        ...
        // 2 knight
        move_list_0x88_O.clear_list();
        this.generated_moves_knight(Chess_board_0x88_C.KNIGHT, piece_color, from, chess_board_0x88_O, move_list_0x88_O);
        for (let i = 0; i < move_list_0x88_O.number_move; i++) {
        ...
        // 3 bishop + 1/2 queen
        move_list_0x88_O.clear_list();
        this.generated_moves_bishop(Chess_board_0x88_C.BISHOP, piece_color, from, chess_board_0x88_O, move_list_0x88_O);
        for (let i = 0; i < move_list_0x88_O.number_move; i++) {
        ...
        // 4 rook + 1/2 queen
        move_list_0x88_O.clear_list();
        this.generated_moves_rook(Chess_board_0x88_C.ROOK, piece_color, from, chess_board_0x88_O, move_list_0x88_O);
        for (let i = 0; i < move_list_0x88_O.number_move; i++) {
        ...
        // 5 pawn
        move_list_0x88_O.clear_list();
        this.generated_moves_pawn(Chess_board_0x88_C.PAWN, piece_color, from, chess_board_0x88_O, move_list_0x88_O);
        for (let i = 0; i < move_list_0x88_O.number_move; i++) {
