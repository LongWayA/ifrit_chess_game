...
class Move_generator_0x88_С {
  ...
  */
    ...
    */
            ...
            if (piece_color == side_to_move) {
                ...
                switch (piece_name) {
                    case Chess_board_0x88_C.KING:// KING
                        ...
                        this.generated_moves_king(piece_color, from, chess_board_0x88_O, move_list_0x88_O);
                        this.generated_moves_castle_king(piece_color, from, chess_board_0x88_O, move_list_0x88_O);
                        break;

                    case Chess_board_0x88_C.QUEEN://QUEEN
                        this.generated_moves_queen(piece_color, from, chess_board_0x88_O, move_list_0x88_O);
                        break;
                    case Chess_board_0x88_C.ROOK://ROOK
                        this.generated_moves_rook(piece_color, from, chess_board_0x88_O, move_list_0x88_O);
                        break;
                    case Chess_board_0x88_C.BISHOP://BISHOP
                        this.generated_moves_bishop(piece_color, from, chess_board_0x88_O, move_list_0x88_O);
                        break;
                    case Chess_board_0x88_C.KNIGHT://KNIGHT
                        this.generated_moves_knight(piece_color, from, chess_board_0x88_O, move_list_0x88_O);
                        break;
                    case Chess_board_0x88_C.PAWN://PAWN
                        this.generated_moves_pawn(piece_color, from, chess_board_0x88_O, move_list_0x88_O);
                        break;
    ...
    generated_moves_king(piece_color, from, chess_board_0x88_O, move_list_0x88_O) {
        ...
        for (let j = 0; j < 8; j++) {
            ...
            if ((to & 136) == 0) {// если мы не вышли за пределы доски
                bre_ak = this.add_move(Chess_board_0x88_C.KING, piece_color, from, to, chess_board_0x88_O, move_list_0x88_O);
            }
        }
    }

    generated_moves_queen(piece_color, from, chess_board_0x88_O, move_list_0x88_O) {
        ...
        for (let j = 0; j < 8; j++) {
            ...
            if ((to & 136) == 0) {// если мы не вышли за пределы доски
                while (true) {
                    bre_ak = this.add_move(Chess_board_0x88_C.QUEEN, piece_color, from, to, chess_board_0x88_O, move_list_0x88_O);
    ...
    generated_moves_rook(piece_color, from, chess_board_0x88_O, move_list_0x88_O) {
        ...
        for (let j = 0; j < 4; j++) {
            ...
            if ((to & 136) == 0) {// если мы не вышли за пределы доски
                while (true) {
                    bre_ak = this.add_move(Chess_board_0x88_C.ROOK, piece_color, from, to, chess_board_0x88_O, move_list_0x88_O);
                    if (bre_ak == 1) break;
    ...
    generated_moves_bishop(piece_color, from, chess_board_0x88_O, move_list_0x88_O) {
        ...
        for (let j = 0; j < 4; j++) {
            ...
            if ((to & 136) == 0) {// если мы не вышли за пределы доски
                while (true) {
                    bre_ak = this.add_move(Chess_board_0x88_C.BISHOP, piece_color, from, to, chess_board_0x88_O, move_list_0x88_O);
                    if (bre_ak == 1) break;
    ...
    generated_moves_knight(piece_color, from, chess_board_0x88_O, move_list_0x88_O) {
        ...
        for (let j = 0; j < 8; j++) {
            ...
            if ((to & 136) == 0) {// если мы не вышли за пределы доски
                bre_ak = this.add_move(Chess_board_0x88_C.KNIGHT, piece_color, from, to, chess_board_0x88_O, move_list_0x88_O);
            }
        }
    }
    ...
    generated_moves_pawn(piece_color, from, chess_board_0x88_O, move_list_0x88_O) {
        ...
        if (piece_color == 1) {// белая пешка
            this.generated_moves_pawn_white(piece_color, from, chess_board_0x88_O, move_list_0x88_O);
        } else if (piece_color == 0) {
            this.generated_moves_pawn_black(piece_color, from, chess_board_0x88_O, move_list_0x88_O);
        }
    }


    //
    generated_moves_pawn_white(piece_color, from, chess_board_0x88_O, move_list_0x88_O) {
        ...
        if (Math.floor(from / 16) == 1) {// белая пешка на на предпоследней позиции(7-ая линия). можно ходить с превращением
            this.generated_moves_pawn_promo(from, (from - 17), (from - 16), (from - 15),
    ...
    //
    generated_moves_pawn_black(piece_color, from, chess_board_0x88_O, move_list_0x88_O) {
        ...
        if (Math.floor(from / 16) == 6) {// 136 0x88
            this.generated_moves_pawn_promo(from, (from + 15), (from + 16), (from + 17), piece_color,
                chess_board_0x88_O, move_list_0x88_O);
        } else {
            this.generated_moves_pawn_one(from, (from + 16), piece_color, chess_board_0x88_O, move_list_0x88_O);
    ...
    generated_moves_pawn_promo(from, to_left, to_center, to_right, piece_color, chess_board_0x88_O, move_list_0x88_O) {
        let piece_color_to = -1;
        let piece_to = -1;
        let capture_piece = -1;
        let type_move = -1;
