  ...
  searching_alpha_beta_id(alpha, beta, pv_line_0x88_O, chess_board_0x88_O, move_gen_1_captures_0x88_O,
    ...
    if (depth >= depth_max) {
      ...
      if (isPV != -1) {// не главный вариант
        ...
        let is_save_position_ws = is_save_position.ws;// тип записанного хода

        if (is_save_position_ws != -1) {
          //console.log("Search_0x88_C-> is_save_position_tm " + is_save_position_tm);
          if ((is_save_position_ws == Hash_table_0x88_C.ALPHA_CUT) && (chess_board_0x88_O.side_to_move == Chess_board_0x88_C.BLACK)) {
            let hash_table_score = hash_table_0x88_O.sk;// оценка записанного хода
          ...
          if ((is_save_position_ws == Hash_table_0x88_C.BETA_CUT) && (chess_board_0x88_O.side_to_move == Chess_board_0x88_C.WHITE)) {
            let hash_table_score = hash_table_0x88_O.sk;
