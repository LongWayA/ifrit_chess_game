...
import { Move_generator_captures_0x88_С } from "../chess_engine_0x88/move_generator/move_generator_captures_0x88.js";
import { Move_generator_quiet_0x88_С } from "../chess_engine_0x88/move_generator/move_generator_quiet_0x88.js";
...
class GuiLegalMove_0x88_С {
  ...
  pseudo_move_is_ok(from_x, from_y, to_x, to_y, chessBoard_8x8_O) {
    ...
    this.move_generator_captures_0x88_O.generated_pseudo_legal_moves_one_piece_for_gui(from,
      this.chess_board_0x88_O_gui,
      this.move_list_0x88_O_gui);

    this.move_generator_quiet_0x88_O.generated_pseudo_legal_moves_one_piece_for_gui(from,
      this.chess_board_0x88_O_gui,
      this.move_list_0x88_O_gui);
